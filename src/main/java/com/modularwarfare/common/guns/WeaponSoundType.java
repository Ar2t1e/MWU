...
public enum WeaponSoundType {
    ...
    @SerializedName("weaponPostReloadSecond") PostReloadSecond("weaponPostReloadSecond", 16, null),
    ...
    @SerializedName("weaponDrawEmpty") DrawEmpty("weaponDrawEmpty", 12, "draw"),
    ...
    @SerializedName("weaponInspect") Inspect("weaponInspect",8,null),
    @SerializedName("weaponInspectEmpty") InspectEmpty("weaponInspectEmpty",8,null),
