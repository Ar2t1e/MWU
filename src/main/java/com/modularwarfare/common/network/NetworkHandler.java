...
public class NetworkHandler extends MessageToMessageCodec<FMLProxyPacket, PacketBase> {
    ...
    public void initialise() {
        ...
        registerPacket(PacketSwitchLaser.class);
        registerPacket(PacketCraftItem.class);
        registerPacket(PacketDestroyBlock.class);
        registerPacket(PacketCustomEffect.class);
        registerPacket(PacketEXPEffect.class);
