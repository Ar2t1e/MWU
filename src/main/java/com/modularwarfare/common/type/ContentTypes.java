...
public class ContentTypes {
    ...
    public static void registerTypes() {
        ...
        registerType("ingredients", IngredientType.class, (type, reload) -> {
            ContentTypes.<IngredientType, IngredientItem>assignType(ModularWarfare.ingredientTypes, IngredientItem.factory, (IngredientType) type, reload);
        });
