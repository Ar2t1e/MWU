...
public class Programs {
    ...
    public static int reticleProgram;
    ...
    public static void init() {
        ...
        if(GL20.glGetShaderi(vertshader, GL20.GL_COMPILE_STATUS)!=GL11.GL_TRUE) {
            throw new RuntimeException(GL20.glGetShaderInfoLog(vertshader, 512));
        }
        ...
        if(GL20.glGetShaderi(fragshader, GL20.GL_COMPILE_STATUS)!=GL11.GL_TRUE) {
            throw new RuntimeException(GL20.glGetShaderInfoLog(fragshader, 512));
        }

        reticleProgram = GL20.glCreateProgram();
        GL20.glAttachShader(reticleProgram, vertshader);
        GL20.glAttachShader(reticleProgram, fragshader);
        GL20.glDeleteShader(vertshader);
        GL20.glDeleteShader(fragshader);
        GL20.glLinkProgram(reticleProgram);
        if(GL20.glGetProgrami(reticleProgram, GL20.GL_LINK_STATUS)!=GL11.GL_TRUE) {
            throw new RuntimeException(GL20.glGetProgramInfoLog(reticleProgram, 512));
        }
