...
public class ScopeUtils {
    ...
    public void renderPostScope(float renderTickTime,boolean isDepthMode,boolean isInsideRendering,boolean isOverlayRendering,float alpha) {
        if (RenderParameters.adsSwitch > 0) {
            ...
            ResourceLocation overlayToRender = attachment.type.sight.overlayType.resourceLocations.get(0);
    ...
    public static void FovZoomAdd(ItemAttachment itemAttachment) {
        double zoomIncrease = 1f;
        if (((ModelAttachment) itemAttachment.type.model).config.sight.fovZoom + zoomIncrease <= ((ModelAttachment) itemAttachment.type.model).config.sight.MaxFovZoom) {
            ((ModelAttachment) itemAttachment.type.model).config.sight.fovZoom += zoomIncrease;
        }
    }

    public static void FovZoomDes(ItemAttachment itemAttachment) {
        double zoomDecrease = 1f;
        if (((ModelAttachment) itemAttachment.type.model).config.sight.fovZoom - zoomDecrease >= ((ModelAttachment) itemAttachment.type.model).config.sight.MinimuFovZoom) {
            ((ModelAttachment) itemAttachment.type.model).config.sight.fovZoom -= zoomDecrease;
        }
    }
