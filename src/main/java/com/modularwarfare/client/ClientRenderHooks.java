...
import com.modularwarfare.client.fpp.enhanced.renderers.RenderType;
            ...
            if (givenEntity instanceof EntitySmokeGrenade) {
                ...
                if (smokeGrenade.exploded) {
                    if (smokeGrenade.smokeTime <= 220) {
                        RenderHelperMW.renderSmoke(grenade_smoke, smokeGrenade.posX, smokeGrenade.posY + 1, smokeGrenade.posZ, 600, 600, "0xFFFFFF", 0.8f);
                    }
                }
            }
        }
